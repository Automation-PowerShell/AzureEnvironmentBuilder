...
$VMNamePrefixPackaging = "vm-euc-van-"                       # Specifies the first part of the Packaging VM name (usually alphabetic) (15 chars max)
...
$VMNumberStartPackaging = 101                                # Specifies the second part of the Packaging VM name (usually numeric)
...
$VMSizePackaging = $deviceSpecs.Packaging.VMSize              # Specifies Azure Size to use for the Packaging VM
